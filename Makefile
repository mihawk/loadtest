...
build-plt:
	@$(DIALYZER) --build_plt --output_plt .loadtest_dialyzer.plt --apps $(DIALYZER_APPS)

dialyze:
	@$(DIALYZER) --src src --plt .loadtest_dialyzer.plt -Werror_handling \
